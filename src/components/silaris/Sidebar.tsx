...
import {
  ...
  GraduationCap, BookOpen, Crown, Mic2, Swords,
  LayoutDashboard, BarChart3, FileBarChart2,
} from "lucide-react";
...
const SECTIONS: Section[] = [
  ...
  { label: "Analytics", items: [
    { to: "/voc",         icon: Mic2,   name: "Voice of Customer", sub: "Pain points & themes" },
    { to: "/competition", icon: Swords, name: "Competition",       sub: "Feature-benefit" },
  ]},
  { label: "Views", items: [
    { to: "/",               icon: LayoutDashboard, name: "Process Overview", sub: "Home" },
    { to: "/call-analytics", icon: BarChart3,       name: "Call Analytics",   sub: "Volume & quality" },
    { to: "/reports",        icon: FileBarChart2,   name: "Reports",          sub: "Exports & audits" },
  ]},
];
