...
import { Shell, Card, Kpi, SectionTitle, Badge } from "@/components/silaris/Shell";
import {
...
function ProcessOverview() {
  ...
  return (
    ...
    >
      <SectionTitle kicker="Home">Process Overview</SectionTitle>
          ...
          <div className="h-[340px]">
            <ResponsiveContainer>
              <ComposedChart data={pareto} margin={{ top: 10, right: 30, bottom: 60, left: 0 }}>
                ...
                <XAxis
                  dataKey="name" stroke="#94a3b8" tick={{ fontSize: 11 }}
                  interval={0} angle={-22} textAnchor="end" height={70}
                />
                <YAxis yAxisId="L" stroke="#94a3b8" tick={{ fontSize: 11 }} unit="%" />
                <YAxis yAxisId="R" orientation="right" stroke="#94a3b8" tick={{ fontSize: 11 }} unit="%" />
                <Tooltip
                  contentStyle={{ background: "#111827", border: "1px solid #1c2940", borderRadius: 8, fontSize: 12 }}
