...
export const AGENTS: Agent[] = [
  {
    ...
    trend: [72, 74, 75, 76],
    primaryGap: "Competition objection handling — hesitates when HDFC / SBI mentioned",
    secondaryGap: "Charges precision under competitor pressure",
    trainingStatus: "Active — Competition Comparison AI module (auto-delivered)",
    callsToday: 21, callsWeek: 87, capStatus: null,
    dimensions: D([14, 14, 10, 11, 12, 13]),
    todaysCalls: [
      { id: "C-88412", duration: "06:24", cqi: 92, tag: "Clean", obs: "Strong opening, full T&C on time",
        high: "Textbook IRDA opening · clean close", low: "—" },
      { id: "C-88419", duration: "04:11", cqi: 78, tag: "Non-Fatal", obs: "HDFC comparison stalled",
        high: "Warm tone, good rapport",
        low: "Could not handle HDFC comparison — hesitated 8 sec, lost momentum" },
      { id: "C-88427", duration: "08:02", cqi: 90, tag: "Clean", obs: "Good rapport + close",
        high: "Confirmed callback with specific time", low: "—" },
      { id: "C-88433", duration: "05:48", cqi: 74, tag: "Non-Fatal", obs: "Wrong SBI FMC quoted",
        high: "Polite recovery after pushback",
        low: "Customer asked about SBI charges — gave wrong FMC number (quoted 1.5%, actual 1.35%)" },
      { id: "C-88441", duration: "07:15", cqi: 91, tag: "Clean", obs: "Clean Cat A handling",
        high: "Used competition cheat sheet correctly", low: "—" },
    ],
    rebuttals: [
      {
        badge: "HDFC",
        scenario: "Customer says HDFC Life is offering zero allocation charge — why is Axis Max more expensive?",
        customer: "Madam, HDFC wale toh zero allocation charge bol rahe hain — aap kyun mehnga de rahe ho?",
        response: "Sir, bilkul sahi sawaal hai. Axis Max Life mein bhi Zero Allocation Charge hai — same as HDFC. Aur extra: FMC bhi 1.35% se ghat ke 0.90% ho jaata hai 10th year ke baad, aur admin charges policy maturity par wapas mil jaate hain. Effectively HDFC se ~1.2% kam cost over 15 years.",
      },
      {
        badge: "SBI",
        scenario: "Customer raises SBI Life's claim settlement reputation.",
        customer: "SBI Life ka claim settlement bahut acha hai, mujhe SBI hi lena chahiye.",
        response: "Sir, SBI ka 97.1% claim settlement ratio achha hai — par Axis Max Life 98.7% par hai, industry mein top 3 mein. Aur hum digital claim 1 din mein settle karte hain. Mai actual IRDA report aapko share kar sakti hoon WhatsApp pe.",
      },
      {
        badge: "Charges",
        scenario: "Customer challenges annual charges as too high.",
        customer: "Saalana charges bahut zyada hain — yeh sab kyun lagte hain?",
        response: "Sir, structure samjhata hoon: Allocation = ZERO, Mortality = age-based (refundable on maturity), FMC = 1.35% pehle 10 saal, fir 0.90%, Admin = ₹500/month — yeh bhi policy maturity par wapas. Net effective charge sirf FMC hai, jo industry mein kam hai.",
      },
    ],
    feedback: {
      aiPattern: "AI detected: Competition comparison queries failed in 66% of calls (8 of 12) over the past 2 weeks. Hesitation > 5 sec when HDFC or SBI is mentioned. Closing and compliance are strong — gap is isolated to competitor objection pivot.",
      strengths: ["Reference-quality IRDA opening", "Confirmed callbacks with anchor times", "Empathetic, warm tone"],
      improvements: ["Memorise HDFC + SBI 3-line pivot scripts", "Carry charges card on every Savings call"],
      actionPlan: "Competition Comparison AI module auto-delivered to desktop. STT monitors HDFC / SBI mentions live; daily CQI re-score. Reassess Day 5.",
      remarks: [
        "Opening greeting clear, IRDA disclosure on time",
        "Product features well-covered for own plan",
        "Lost ground when customer said 'HDFC zero charge bol rahe hain'",
        "Customer handling — patient, builds trust",
        "Closing summary present, callback confirmed in 9/10 calls",
        "Compliance disclosure within 30s in 10/10 calls",
      ],
    },
    training: {
  ...
  },
  {
    ...
    todaysCalls: [
      { id: "C-88502", duration: "05:33", cqi: 70, tag: "Non-Fatal", obs: "T&C disclosed at 1:42",
        high: "Recovered with strong product walkthrough",
        low: "T&C at 1:42 instead of within 30 sec — IRDA window breached" },
      { id: "C-88511", duration: "06:01", cqi: 74, tag: "Clean", obs: "T&C on time, weak close",
        high: "Clean IRDA disclosure inside 25s", low: "Closing flat — no benefit summary" },
      { id: "C-88520", duration: "04:42", cqi: 68, tag: "Non-Fatal", obs: "No urgency in closing",
        high: "Patient with repeated questions", low: "Closing missed urgency + commitment ask" },
      { id: "C-88528", duration: "07:09", cqi: 75, tag: "Clean", obs: "Best call of the day",
        high: "Rider explanation textbook", low: "—" },
      { id: "C-88535", duration: "05:21", cqi: 69, tag: "Non-Fatal", obs: "Did not summarize benefits",
        high: "Good rapport throughout", low: "Skipped 3-benefit recap before closing" },
    ],
    rebuttals: [
      {
        badge: "SIMPLIFY",
        scenario: "Customer feels the plan is too complicated to grasp.",
        customer: "Yeh bahut complicated hai, mujhe samajh nahi aa raha.",
        response: "Sir, bilkul simple kar deta hoon — sirf 3 baatein: (1) aap monthly ₹X dete ho, (2) 10 saal baad fund triple ho jaata hai, (3) anytime nikaal sakte ho 5 saal ke baad. Bas. Baaki sab document mein hai.",
      },
      {
        badge: "T&C",
        scenario: "Customer protests that T&C are too long to listen to.",
        customer: "T&C bahut lambi hai, chhoro yeh sab — main bilkul busy hoon.",
        response: "Sir, sirf 2 baatein bolni hain IRDA ke liye — 10 second mein: yeh call recorded hai, aur Axis Max Life ki taraf se insurance + investment plan offer kar raha hoon. Ho gaya. Ab aapki priority — investment ya cover?",
      },
    ],
    feedback: {
      aiPattern: "AI detected: T&C disclosure delayed in 3 of 5 calls today (60% breach). Pattern is consistent over 14 days — agent completes greeting + small talk before disclosure. Closing dimension also trails (9/13).",
  ...
  },
  {
    ...
    todaysCalls: [
      { id: "C-88601", duration: "07:42", cqi: 94, tag: "Clean", obs: "Textbook execution, full T&C",
        high: "Reference-quality IRDA opening", low: "—" },
      { id: "C-88608", duration: "06:18", cqi: 93, tag: "Clean", obs: "Empathetic handling of objection",
        high: "De-escalated SBI objection in 12 sec", low: "—" },
      { id: "C-88614", duration: "05:51", cqi: 95, tag: "Clean", obs: "Closed Step-Up plan",
        high: "Closed Step-Up plan with anchored callback", low: "—" },
      { id: "C-88622", duration: "08:33", cqi: 94, tag: "Clean", obs: "Excellent competition pivot",
        high: "HDFC pivot — used full charges card", low: "—" },
      { id: "C-88629", duration: "06:47", cqi: 92, tag: "Clean", obs: "Smooth reconfirmation",
        high: "Reconfirmation 3 of 3 elements", low: "—" },
    ],
    rebuttalsNote: "STAR performer — no rebuttals needed. Anita is available for peer coaching across HDFC / SBI pivots and IRDA closing.",
    feedback: {
      aiPattern: "Consistent Category A across 92 audited calls this month. Role model for competition handling and compliance. Calls used as the gold-standard reference for peer training.",
  ...
  },
  {
    ...
    todaysCalls: [
      { id: "C-88701", duration: "09:14", cqi: 41, tag: "Fatal", obs: "FATAL — unauthorized fee waiver",
        high: "—", low: "Promised fee waiver without authorization — IRDA mis-selling breach" },
      { id: "C-88708", duration: "04:22", cqi: 38, tag: "Fatal", obs: "Pressure-selling language",
        high: "—", low: "Told customer 'policy lapse nahi hogi' — pressure-selling language flagged" },
      { id: "C-88712", duration: "05:01", cqi: 55, tag: "Non-Fatal", obs: "Charges not disclosed upfront",
        high: "Rapport-building decent", low: "Charges disclosed only at 4:10 — well beyond opening" },
      { id: "C-88716", duration: "03:48", cqi: 60, tag: "Non-Fatal", obs: "Closing technique weak",
        high: "Polite tone", low: "No summary, no urgency, no commitment ask" },
      { id: "C-88720", duration: "—",     cqi: 0,  tag: "Fatal", obs: "Suspended from outbound",
        high: "—", low: "Outbound suspended pending CAP-2 compliance certification" },
    ],
    rebuttalsNote: "Restricted set — agent on CAP-2. Single approved de-escalation script below; all other rebuttals must be cleared by TL + Compliance.",
    rebuttals: [
      {
        badge: "WAIVER",
        scenario: "Customer demands fee waiver — agent must de-escalate without promising anything.",
        customer: "Charges itne kyun hain? Kuch waiver de do bhai.",
        response: "Sir, main personally kuch waive nahi kar sakta — yeh IRDA-regulated charges hain. Aur achhi baat yeh hai ki Axis Max Life mein allocation charge ZERO hai already, aur admin charges policy maturity par wapas mil jaate hain. Effectively jo aap dete ho woh wapas milta hai.",
      },
    ],
    feedback: {
      aiPattern: "FATAL compliance breaches — 3rd offense in 30 days. Phrases like 'guaranteed return' and 'fee waiver' detected by STT. CAP-2 triggered; agent suspended from outbound pending Compliance sign-off.",
  ...
  },
  {
    ...
    todaysCalls: [
      { id: "C-88801", duration: "05:18", cqi: 70, tag: "Clean", obs: "Used new closing template",
        high: "3-S close applied — summary, safety, step", low: "—" },
      { id: "C-88809", duration: "06:44", cqi: 67, tag: "Non-Fatal", obs: "Customer said 'sochta hoon'",
        high: "Listened actively, paraphrased need",
        low: "Customer said 'sochta hoon' — agent didn't attempt retention, accepted the no" },
      { id: "C-88815", duration: "04:50", cqi: 71, tag: "Clean", obs: "Created urgency well",
        high: "Free-look + callback time anchored", low: "—" },
      { id: "C-88823", duration: "05:55", cqi: 66, tag: "Non-Fatal", obs: "Soft close, no next-step",
        high: "Warm rapport throughout", low: "Closed with 'thank you' — no commitment ask" },
      { id: "C-88830", duration: "07:08", cqi: 69, tag: "Clean", obs: "Strong rapport + benefit recap",
        high: "Recapped 3 benefits cleanly", low: "—" },
    ],
    rebuttals: [
      {
        badge: "RETENTION",
        scenario: "Customer says they want to think about it — classic stall.",
        customer: "Theek hai, main soch ke batata hoon.",
        response: "Sir bilkul, ek minute — recap karta hoon: (1) Zero allocation charge, (2) 22 fund options with free switching, (3) admin charges maturity par wapas. Aur 15-din ka free-look bhi hai. Kya hum aaj hi process start kar dein? Worst case 15 din mein cancel kar sakte ho.",
      },
      {
        badge: "TIMING",
        scenario: "Customer pushes back saying they're busy right now.",
        customer: "Abhi time nahi hai, baad mein baat karte hain.",
        response: "Bilkul samjhta hoon sir, sirf 2 minute lungi — aaj enrolment karne par lock-in rate aaj ki hi rahega, kal premium ₹X badh sakta hai age slab change ke wajah se. Quick 60-second summary sun lein, fir aap decide karein?",
      },
    ],
    feedback: {
      aiPattern: "Improved from Cat C to Cat B in 4 weeks after AI training! Closing dimension still trails (7/13). Pattern: ends with 'thank you' but skips benefit summary + commitment ask. Trajectory points to Cat A by month-end.",
  ...
  },
  {
    ...
    todaysCalls: [
      { id: "C-88901", duration: "06:22", cqi: 57, tag: "Non-Fatal", obs: "Could not explain rider benefits",
        high: "Compliance clean", low: "Could not explain Step-Up rider benefits — customer disengaged" },
      { id: "C-88908", duration: "05:14", cqi: 60, tag: "Non-Fatal", obs: "Dead air on fund question",
        high: "Polite tone maintained", low: "Dead air 9 seconds after fund-switch question" },
      { id: "C-88912", duration: "04:33", cqi: 55, tag: "Non-Fatal", obs: "Wrong FMC quoted",
        high: "Recovered with apology", low: "Quoted FMC as 1.5% — actual is 1.35%" },
      { id: "C-88917", duration: "07:01", cqi: 61, tag: "Non-Fatal", obs: "Avoided rider question entirely",
        high: "Closing reasonable", low: "Avoided rider question — said 'document mein milega'" },
      { id: "C-88925", duration: "05:48", cqi: 58, tag: "Non-Fatal", obs: "Customer frustrated",
        high: "—", low: "Customer frustrated — repeated same question 3 times" },
    ],
    rebuttals: [
      {
        badge: "PRODUCT",
        scenario: "Customer asks a product-detail question — bridge until classroom training completes.",
        customer: "Step-Up rider kya hota hai? Aur fund switch karne mein koi cost hai?",
        response: "Sir, Step-Up rider matlab har 3 saal mein aap apna sum-assured automatically badha sakte ho without fresh medicals. Fund switching is FREE & unlimited across 22 funds — koi cost nahi. Detailed walkthrough ke liye main aapko expert se connect kara doon — 10 minute mein call back?",
      },
    ],
    feedback: {
      aiPattern: "AI coaching did not improve scores (60 → 58 over 5 days, stagnant). Escalated to Trainer + TL for 2-week classroom + shadowing programme. CAP-1 maintained until reassessment.",
...
// Training screens
export const TRAINING_PIPELINE: { stage: string; count: string; tone: "blue" | "green" | "amber" | "mixed" }[] = [
  { stage: "Detected",   count: "34", tone: "blue" },
  { stage: "Generated",  count: "28", tone: "blue" },
  { stage: "Delivered",  count: "23", tone: "green" },
  { stage: "Opened",     count: "21", tone: "green" },
  { stage: "Assessment", count: "8",  tone: "amber" },
  { stage: "Monitoring", count: "15", tone: "green" },
